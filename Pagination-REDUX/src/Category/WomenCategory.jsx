...
export default function WomenCategory() {
  ...
  const womenCategory = productData.data?.filter(
    ...
    <div className="bg-black min-h-screen text-white">
      ...
      <div className="flex gap-[20px] mx-[2%] flex-wrap pt-6">
        ...
        {womenCategory?.map((product) => (
          <div
            key={product.id}
            className="w-[100%] sm:w-[48%] md:w-[32%] lg:w-[23%] bg-gray-900 border border-gray-700 p-5 rounded-[10px] shadow-md transition-transform transform hover:scale-105"
          >
